...
[Deutsch: Einrichtung](DESKTOP-DE.md) ·
[Desktop guide](BINARIES.md) ·
[Setup assistant](SETUP.md) ·
[Home Assistant / HACS](HOME_ASSISTANT.md)

Version 0.3.0 adds [Google Play download without an Android device](GOOGLE_PLAY.md)
...
| --- | --- | --- |
| Watch on Windows, Linux or macOS | Bridge binary, VLC, your private camera configuration | [Desktop binaries](BINARIES.md) |
| Watch in Home Assistant, with sound | Reachable bridge **0.1.2+**, FFmpeg on the bridge computer, HACS integration | [Home Assistant setup](HOME_ASSISTANT.md) |
| Prepare a new account in 0.2.0 | Complete desktop package with setup helper, own app files or connected Android phone, Momcozy login | [Setup assistant](SETUP.md) |
| Build and run from source | Git, Go, Python; VLC for desktop playback | [Windows / Linux / macOS](DESKTOP-DE.md) |
...
verified; see [phone-free research](PHONE_FREE_RESEARCH.md).
...
See [complete audio configuration](HOME_ASSISTANT.md#optional-audio-conversion-for-home-assistant).
...
- [Protocol notes](PROTOCOL.md), [security and private state](../SECURITY.md),
  [contributing](../../CONTRIBUTING.md), [license notices](../../NOTICE.md).

The repository was renamed from `Gamewalker/momcozy-desktop`. See
[updating an existing installation](HOME_ASSISTANT.md#repository-rename).
